...
class AfterSale extends ClientbaseController{
	...
	public function add(){
        ...
        // 后台改价优惠
        $diy_discount = $goods['diy_discount'];
        $one_diy_discount = priceFormat($diy_discount / $goods['goods_number'],false,6);
        $return_diy_discount = $goods['after_sale_num'] * $one_diy_discount;
        // 优惠券优惠
        ...
        $return_price = $goods['sale_price'] - $one_bonus_price - $one_diy_discount;
        
        $end_return_all = $goods['sale_price'] * $goods['return_num'] - ($usd_bonus_price - $return_bouns_money) - ($diy_discount - $return_diy_discount);
