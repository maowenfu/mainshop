...
class Goods extends AdminController
{
    ...
    public function asInfo($data)
    {
        ...
        $data['rank_award'] = json_decode($data['rank_award'],true);
        $data['award'] = json_decode($data['award'],true);
        $data['level_award'] = json_decode($data['level_award'],true);
        // print_r($data);
    ...
    private function checkData($row)
    {
        ...
        $row['rank_award'] = json_encode($row['rank_award']);
        $row['award'] = json_encode($row['award']);
        $row['level_award'] = json_encode($row['level_award']);
        return $row;
    }
