<?php /*a:3:{s:52:"F:\WWW\M\application\mainadmin\view\index\index.html";i:1613985988;s:53:"F:\WWW\M\application\mainadmin\view\layouts\base.html";i:1613985988;s:53:"F:\WWW\M\application\mainadmin\view\layouts\page.html";i:1613985988;}*/ ?>
...
<?php if($is_order == 1): ?>
    <section class="panel panel-default ">
        <?php if($isClearSetTip == true): ?>
        <header class="panel-heading font-bold red">
            检测到网站发现变化，是否要清理相关配置，<a href="<?php echo url('mainadmin/backup_db/clear'); ?>" class="btn btn-sm" >前往清理</a>
        </header>
        <?php endif; ?>
    ...
    <section class="panel panel-default ">
        <div class="row m-l-none m-r-none bg-light lter">
            ...
            <div class="col-sm-6 col-md-3 padder-v b-r b-light lt">
                ...
                <a class="fl" href="<?php echo url('member/sys_admin.users/index',['time_type'=>'reg_time','start_time'=>$today,'end_time'=>$today]); ?>">
                ...
                <a class="fr" href="#">
                    <span class="h3 block m-t-xs"><strong id="y_day_new_user"><?php echo htmlentities($userStats['today_sign']); ?></strong></span>
            ...
            <div class="col-sm-6 col-md-3 padder-v b-r b-light">
                ...
                <a class="fl" href="<?php echo url('member/sys_admin.users/index'); ?>">
                ...
                <a class="fr" href="<?php echo url('member/sys_admin.users/index',array('rode_id'=>'all_role')); ?>">
            ...
            <div class="col-sm-6 col-md-3 padder-v b-r b-light lt">
                ...
                <a class="fr" href="#">
                    <span class="h3 block m-t-xs"><strong id="bean_total"><?php echo htmlentities(intval($account['use_integral'])); ?></strong></span>
...
<script type="text/javascript">
    $(function () {
        ...
        $('#total_money').highcharts({
            ...
            jq_ajax('<?php echo url("distribution/sys_admin.setting/autoEval"); ?>');
            jq_ajax('<?php echo url("shop/sys_admin.order/autoSign"); ?>');
        });
    </script>
<?php endif; ?>
</section>
