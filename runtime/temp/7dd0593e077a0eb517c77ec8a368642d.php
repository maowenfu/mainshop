<?php /*a:4:{s:65:"F:\WWW\M\application\distribution\view\sys_admin\award\index.html";i:1613985988;s:53:"F:\WWW\M\application\mainadmin\view\layouts\base.html";i:1613985988;s:64:"F:\WWW\M\application\distribution\view\sys_admin\award\list.html";i:1613985988;s:53:"F:\WWW\M\application\mainadmin\view\layouts\page.html";i:1613985988;}*/ ?>
     ...
     <div class="page-breadcrumbs">
            <ul class="breadcrumb" >
                <li>
                    ...
                    <strong>分销奖项列表</strong>
                </li>                                  
            </ul>
             
            <a href="<?php echo url('info'); ?>"  title="添加奖项" class="btn btn-sm btnbtn-default fr  m-t-md m-r"><i class="fa fa-plus m-r-xs"></i>添加奖项</a>
        </div>
    </form>
</header>
...
<tr>
    <td><?php echo htmlentities($vo['award_name']); ?></td>
    <td><?php echo htmlentities($vo['limit_role_name']); ?></td>
    <td><?php echo htmlentities(dateTpl($vo['update_time'])); ?></td>
    <td>  <a href="<?php echo url('info',array('award_id'=>$vo['award_id'])); ?>"   class="m-xs" title="编辑">
            <i class="fa fa-edit text-muted"></i>
        </a>
        <a href="<?php echo url('delete',array('award_id'=>$vo['award_id'])); ?>" data-toggle="ajaxRemove" data-msg="确定删除 <?php echo htmlentities($vo['award_name']); ?>" class="m-xs" title="删除">
