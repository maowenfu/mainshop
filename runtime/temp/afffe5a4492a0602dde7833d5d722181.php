<?php /*a:4:{s:61:"F:\WWW\M\application\shop\view\sys_admin\goods_tag\index.html";i:1613985989;s:53:"F:\WWW\M\application\mainadmin\view\layouts\base.html";i:1613985988;s:60:"F:\WWW\M\application\shop\view\sys_admin\goods_tag\list.html";i:1613985989;s:53:"F:\WWW\M\application\mainadmin\view\layouts\page.html";i:1613985988;}*/ ?>
...
<header class="header  b-b clearfix">
    <form id="forms" class="talbe-search form-inline "  method="post" action="<?php echo url('getList'); ?>" >
         <div class="page-breadcrumbs">
                ...
                <a href="<?php echo url('info'); ?>" class="btn btn-sm btn-default fr m-t-md m-r"><i class="fa fa-plus m-r-xs"></i>新增商品标签</a>
...
<?php if(is_array($data['list']) || $data['list'] instanceof \think\Collection || $data['list'] instanceof \think\Paginator): $i = 0; $__LIST__ = $data['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
        <tr>
       	  	...
       	  	<td><?php echo htmlentities($vo['title']); ?>（<?php echo htmlentities($vo['subtitle']); ?>）</td>
            <td><?php echo htmlentities($vo['goods_num']); ?></td>
            <td><?php echo htmlentities($vo['sort_order']); ?></td>
            <td>
                <a href="#" data-remote="<?php echo url('ajaxEdit',array('id'=>$vo['id'],'field'=>'status')); ?>" class="<?php echo htmlentities(tplckval($vo['status'],'=1','active')); ?>"  data-toggle="class" data-ajax="true"><i class="fa fa-check text-success text-active"></i><i class="fa fa-times text-danger text"></i></a>
            </td>
            ...
            <td>
                ...
                <a href="<?php echo url('del',array('id'=>$vo['id'])); ?>" data-toggle="ajaxRemove" data-msg="确定删除该幻灯片？" class="m-xs" title="删除">
