<?php /*a:4:{s:64:"F:\WWW\M\application\supplyer\view\sys_admin\supplyer\index.html";i:1613985989;s:53:"F:\WWW\M\application\mainadmin\view\layouts\base.html";i:1613985988;s:63:"F:\WWW\M\application\supplyer\view\sys_admin\supplyer\list.html";i:1613985989;s:53:"F:\WWW\M\application\mainadmin\view\layouts\page.html";i:1613985988;}*/ ?>
    ...
    <form id="forms" class="talbe-search form-inline "  method="post" action="<?php echo url('getList'); ?>" >
     <div class="page-breadcrumbs">
            <ul class="breadcrumb" >
              ...
              <input type="text" class="form-control input-large" value="" name="keyword" placeholder="供应商ID/名称" data-rule-required="true" />
              <button class="btn btn-sm btn-default-iq" type="submit" title="搜索"><i class="fa fa-search"></i></button>
              <a href="<?php echo url('info'); ?>"  title="添加供应商" class="btn btn-sm btn-default fr m-t-md m-r"><i class="fa fa-plus m-r-xs"></i>添加供应商</a>
         <a href="/supplyer"  target="_blank" class="btn btn-sm btn-default fr m-t-md m-r"><i class="fa fa-go m-r-xs"></i>前往供应商后台</a>
        </div>
    </form>
</header>
...
<tr>
	<td><?php echo htmlentities($vo['supplyer_id']); ?></td>
    <td><?php echo htmlentities($vo['supplyer_name']); ?></td>
    <td><?php echo htmlentities(dateTpl($vo['add_time'])); ?></td>
    <td><?php echo htmlentities(dateTpl($vo['login_time'])); ?></td>
   <td><a href="javascript:;"  class="<?php echo htmlentities(tplckval($vo['is_ban'],'=0','active')); ?>"><i class="fa fa-check text-success text-active"></i><i class="fa fa-times text-danger text"></i></a></td>
	<td>
<a href="<?php echo url('supplyer/sys_admin.order/index',['supplyer_id'=>$vo['supplyer_id']]); ?>" target="_blank" title="查看订单" class="fa fa-shopping-cart text-muted m-xs"></a>
<a href="<?php echo url('supplyer/sys_admin.goods/index',['supplyer_id'=>$vo['supplyer_id']]); ?>" target="_blank" title="查看商品" class="fa fa-gift text-muted m-xs"></a>
<a href="<?php echo url('supplyer/sys_admin.statistics/index',['supplyer_id'=>$vo['supplyer_id']]); ?>" target="_blank" title="查看统计" class="fa fa-pie-chart text-muted m-xs"></a>
<a href="<?php echo url('info',['supplyer_id'=>$vo['supplyer_id']]); ?>" title="编辑" class="fa fa-edit text-muted m-xs" ></a>
