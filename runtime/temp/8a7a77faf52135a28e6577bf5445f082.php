<?php /*a:4:{s:57:"F:\WWW\M\application\shop\view\sys_admin\goods\index.html";i:1613985989;s:53:"F:\WWW\M\application\mainadmin\view\layouts\base.html";i:1613985988;s:56:"F:\WWW\M\application\shop\view\sys_admin\goods\list.html";i:1614089024;s:53:"F:\WWW\M\application\mainadmin\view\layouts\page.html";i:1613985988;}*/ ?>
...
<header class="header  b-b clearfix">
    <form id="forms" class="talbe-search form-inline "  method="post" action="<?php echo url($is_delete==0?'getList':'trashList'); ?>" >
     <div class="page-breadcrumbs">
        ...
        <?php if(!(empty($brandListOpt) || (($brandListOpt instanceof \think\Collection || $brandListOpt instanceof \think\Paginator ) && $brandListOpt->isEmpty()))): ?>
         <select name="brand_id" style="width: 150px;" data-notsearch="true" data-toggle="select2" data-chang="submit">
             <option value="">所有品牌</option>
             <?php echo $brandListOpt; ?>
         </select>
         <?php endif; ?>
         <select name="cat_id" style="width: 150px;" data-notsearch="true" data-toggle="select2" data-chang="submit">
             <option value="">所有分类</option>
             <?php echo $classListOpt; ?>
         </select>
         <select name="is_promote" style="width: 120px;" data-notsearch="true" data-toggle="select2"
                 data-chang="submit">
             <option value="-1">限时促销</option>
             <option value="1">是</option>
             <option value="0">否</option>
         </select>

         <select name="status" style="width: 80px;" data-notsearch="true" data-toggle="select2"  data-chang="submit">
             ...
             <option value="2">未上架</option>
              ...
              <?php if($is_delete == 0 && $is_supplyer == false): ?>
...
<?php if(is_array($data['list']) || $data['list'] instanceof \think\Collection || $data['list'] instanceof \think\Paginator): $i = 0; $__LIST__ = $data['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
    <tr>
        ...
        <td><?php echo $vo['is_spec']==0 ? htmlentities($vo['shop_price']) : htmlentities($vo['min_price'].'~'.$vo['max_price']); ?></td>
        <td><?php echo $vo['goods_type']==1 ? '普通商品' : '排位商品'; ?></td>
        ...
        <td align="center"><?php echo htmlentities((isset($tagList[$vo['tag_id']]['title']) && ($tagList[$vo['tag_id']]['title'] !== '')?$tagList[$vo['tag_id']]['title']:'--')); ?></td>
        <td align="center"><?php echo htmlentities($vo['goods_number']); ?></td>
