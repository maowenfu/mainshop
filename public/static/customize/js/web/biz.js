        ...
        biz.selector = {
            select: function(params) {
                ...
                if (modalObj.length <= 0) {
                    ...
                    modal += '<div class="row">';
                    modal += '<div class="input-group border_r '+(params.iq_auto==true?'hide':'')+'">';
                    modal += '<input type="text" class="form-control" name="keyword" id="' + name + '_input" placeholder="' + (params.placeholder === undefined ? '请输入关搜索键字': params.placeholder) + '" />';
